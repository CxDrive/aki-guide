...
anyway
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_04){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_05){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_06){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_07){:.centered-img}
this is what you should see
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_08){:.centered-img}
it'll be pretty embarrassing if I goof here eh
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_09){:.centered-img}
but yes, note the changes in red
et voila
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_10){:.centered-img}
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_11){:.centered-img}

### Lesson 2

Aite people
time for the next exercise
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_12){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_13){:.centered-img}
out of habit, I tend to press "Search All", because it tells you the offset at the bottom
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_14){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_15){:.centered-img}
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_16){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_17){:.centered-img}
6) Save your changes in HxD and then rebuild your rom in VPW Studio (Ctrl+Shift+B)
this is what you should end up with
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_18){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_19){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_20){:.centered-img}
Then I adjust everything so that the gaps are closed:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_21){:.centered-img}
there's a gap just big enough for all the nWo Red people
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_22){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_23){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_24){:.centered-img}
After you've arrived at this specific offset
make sure you're at this starting point
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_25){:.centered-img}
Then press ctrl+E to open the "Select Block option"
your list of wrestler addresses has a length (in hex) of 168
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_26){:.centered-img}
you should now have the whole thing selected:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_27){:.centered-img}
...
it should do this
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_28){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_29){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_30){:.centered-img}
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_31){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_32){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_33){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_34){:.centered-img}
Now, search for "8003A1EC" in HxD again

these should be the only changes you make in your ROM at this stage
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_35){:.centered-img}
save in HxD and then build your ROM again in VPW Studio
this turned out okay
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_36){:.centered-img}
this did not
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_37){:.centered-img}
now this comes into play
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_38){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_39){:.centered-img}
make that change accordingly in HxD:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_40){:.centered-img}
save in HxD and then build your ROM again in VPW Studio
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_41){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_42){:.centered-img}

observe this very technical schematic of what we intend to do
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_43){:.centered-img}
By moving Sherri, we're causing some serious things to happen
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_44){:.centered-img}
everything highlighted here will have to change
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_45){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_46){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_47){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_48){:.centered-img}
because we haven't effected the stable changes yet
but if you go to the Flock...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_49){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_50){:.centered-img}
we'll first change the 0005 to 0006 in-ROM, just like our spreadsheet says
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_51){:.centered-img}
save and build your ROM
Sherri's in the correct spot now:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_52){:.centered-img}
but is also still here:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_53){:.centered-img}
we now have to change this value:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_54){:.centered-img}

that value becomes 8003A228
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_55){:.centered-img}
Save and build your ROM
Raven's now back where he's supposed to be
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_56){:.centered-img}
but then you move to the next stable and you begin to see the road ahead of you
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_57){:.centered-img}
...
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_58){:.centered-img}
these are the values you'll need to have in order for Sherri to be in your roster without impacting any other stable

In-ROM:
![Screenshot](../../assets/img/{{ page.assetid }}/{{ page.assetid }}_59){:.centered-img}
